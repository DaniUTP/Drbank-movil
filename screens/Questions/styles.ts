...
export const styles = StyleSheet.create({
  ...
  questionHeaderRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 10 },
  questionNumber: { fontSize: 14, fontWeight: "500", flexShrink: 1 },
  navigatorTrigger: { minHeight: 34, paddingHorizontal: 10, borderRadius: 10, flexDirection: "row", alignItems: "center", gap: 5 },
  navigatorTriggerText: { color: "#0284c7", fontSize: 11, fontWeight: "800" },
  ...
  questionNavigatorModal: { width: "100%", maxWidth: 400, borderRadius: 24, padding: 20, flexGrow: 0, flexShrink: 1 },
  questionNavigatorHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 12 },
  questionNavigatorHeading: { flex: 1 },
  questionNavigatorTitle: { fontSize: 19, fontWeight: "800" },
  questionNavigatorSubtitle: { marginTop: 4, fontSize: 12, lineHeight: 17 },
  questionNavigatorClose: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  questionNavigatorCloseText: { fontSize: 24, lineHeight: 26, fontWeight: "500" },
  questionNavigatorLegend: { flexDirection: "row", flexWrap: "wrap", gap: 14, marginTop: 18, marginBottom: 14 },
  legendItem: { flexDirection: "row", alignItems: "center", gap: 5 },
  legendDot: { width: 9, height: 9, borderRadius: 5 },
  legendDotPending: { borderWidth: 1 },
  legendText: { fontSize: 11, fontWeight: "600" },
  questionNavigatorRangeRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 10 },
  questionNavigatorRange: { fontSize: 13, fontWeight: "800" },
  questionNavigatorPage: { fontSize: 11, fontWeight: "600" },
  questionNavigatorGrid: { flexDirection: "row", flexWrap: "wrap", columnGap: 9, rowGap: 10 },
  questionNavigatorItem: { width: "22.5%", height: 46, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  questionNavigatorItemAnswered: { backgroundColor: "#16a34a", borderColor: "#16a34a" },
  questionNavigatorItemCurrent: { backgroundColor: "#0284c7", borderColor: "#38bdf8", borderWidth: 2 },
  questionNavigatorItemText: { fontSize: 13, fontWeight: "800" },
  questionNavigatorItemTextActive: { color: "#ffffff" },
  questionNavigatorPagination: { flexDirection: "row", gap: 10, marginTop: 16 },
  questionNavigatorPageButton: { flex: 1, minHeight: 42, borderRadius: 12, borderWidth: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 3 },
  questionNavigatorPageButtonDisabled: { opacity: 0.45 },
  questionNavigatorPageButtonText: { fontSize: 12, fontWeight: "800" },
  ...
  distractorItemHeader: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 10 },
  distractorItemBadge: {
    width: 28,
    height: 28,
    borderRadius: 14,
